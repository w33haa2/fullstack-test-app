      ...
      <div class="relative flex h-16 justify-between">
        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          <div class="flex flex-shrink-0 items-center">
            <img class="h-8 w-auto" src="https://go.team/wp-content/uploads/2022/05/goteam-logo-dark.png" alt="Your Company">
          </div>
          <div class="hidden sm:ml-24 sm:flex sm:space-x-8">
            <!-- Current: "border-indigo-500 text-gray-900", Default: "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700" -->
            <a href="#" class="inline-flex items-center px-1 pt-1 text-sm font-normal border-b-2 border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700">Careers</a>
            <a href="#" class="inline-flex items-center border-b-2 font-normal border-transparent px-1 pt-1 text-sm text-gray-500 hover:border-gray-300 hover:text-gray-700">Find Your Role</a>
          </div>
        </div>
